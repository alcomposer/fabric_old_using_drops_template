...
void FabricUI::initTabFilter()
{
    ...
    fFilterLFOType->setMenuFont("FabricIcons",
                                reinterpret_cast<const uchar *>(fonts::fabric_iconsData),
                                fonts::fabric_iconsDataSize);
    ...
    fFilterLFOTypeMenu->setFont("Fabric Icons",
                                reinterpret_cast<const uchar *>(fonts::fabric_iconsData),
                                fonts::fabric_iconsDataSize);
